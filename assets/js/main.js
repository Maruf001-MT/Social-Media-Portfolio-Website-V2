    ...
    ["119"], {
        ...
        9461: function(e, t, a) {
            ...
            n.define("brand", e.exports = function(e) {
                ...
                //     var a, n, o, f = d.attr("data-wf-status"),
                //         p = d.attr("data-wf-domain") || "";
                //     /\.webflow\.io$/i.test(p) && c.hostname !== p && (f = !0), f && !l && (t = t || (a = e('<a class="w-webflow-badge"></a>').attr("href", "https://webflow.com?utm_campaign=brandjs"), n = e("<img>").attr("src", "https://d3e54v103j8qbb.cloudfront.net/img/webflow-badge-icon-d2.89e12c322e.svg").attr("alt", "").css({
                //         marginRight: "4px",
                //         width: "26px"
                //     }), o = e("<img>").attr("src", "https://d3e54v103j8qbb.cloudfront.net/img/webflow-badge-text-d2.c82cec3b78.svg").attr("alt", "Made in Webflow"), a.append(n, o), a[0]), u(), setTimeout(u, 500), e(i).off(r, s).on(r, s))
                // }, a
            })
        },
        322: function(e, t, a) {
        ...
        8955: function(e, t, a) {
            ...
            let {
                ...
                let {
                    type: n
                } = t.nativeEvent, i = -1 !== [x, w].indexOf(n) ? n === x : a.isActive, d = { ...a,
                    isActive: i
                };
                ...
                handler: (n = (e, t) => {
                    ...
                    return !o[n.action.config.autoStopEventId] && t.triggered ? t : n.eventTypeId === S === a ? (Q(e), { ...t,
                        triggered: !0
                    }) : t
                }, (e, t) => {
                    let a = { ...t,
                            ...
                            case c.EventBasedOn.PAGE:
                                {
                                    let {
                                        ...
                                        scrollWidth: a,
                                        scrollHeight: n
                                    } = et();b = g ? Math.min(e + I, a) / a : Math.min(t + T, n) / n;
                                    break
                                }
                                ...
                                case et:
                                    {
                                        ...
                                        } = n.config,
                                        {
                                            widthValue: o,
                                            heightValue: l
                                        } = a;void 0 !== o && (t === D && (t = "px"), eD(e, h, d), c(e, h, o + t)),
                                        void 0 !== l && (i === D && (i = "px"), eD(e, C, d), c(e, C, l + i));
                                        break
                                    }
                                case J:
                                    var l = n.config;
                                ...
                                case ei:
                                    {
                                        let t = el[n.actionTypeId],
                                            ...
                                            r = a.aValue;eD(e, t, d),
                                        c(e, t, r >= 1 ? `rgb(${i},${o},${l})` : `rgba(${i},${o},${l},${r})`);
                                        break
                                    }
                                default:
                                    {
                        ...
                        case b:
                            {
                                ...
                                r = e;
                                return (0, d.getIn)(r, [a, n]) !== n && (r = R(r, n, c, a, o)),
                                v(r, a, l, i, o)
                            }
                        case m:
                            {
